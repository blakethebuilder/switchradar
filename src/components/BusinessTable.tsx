...
import { Building2, Mail, Map, Trash2, Landmark, Smartphone, Route, CheckSquare, Square, Plus } from 'lucide-react';
          ...
          >
            <table className="w-full text-left border-collapse table-fixed min-w-[1200px]">
              ...
              <tbody>
                ...
                {visibleBusinesses.map((business) => {
                  ...
                  return (
                    <tr
                      key={business.id}
                      className={`group cursor-pointer transition-colors ${isSelected ? 'bg-indigo-50/50' : 'hover:bg-indigo-50/30'
                        }`}
              ...
              <tfoot className="sticky bottom-0 z-10">
                <tr className="bg-slate-50/90 backdrop-blur-sm border-t border-slate-200">
                    ...
                    <div className="flex flex-col items-center gap-3">
                      ...
                      {hasMore && (
                        <button
                          ...
                          disabled={loading}
                          className="group relative flex items-center justify-center gap-2 px-8 py-2.5 bg-indigo-600 text-white rounded-full text-xs font-black uppercase tracking-widest hover:bg-indigo-700 transition-all active:scale-95 shadow-lg shadow-indigo-100 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                          {loading ? (
                            <>
