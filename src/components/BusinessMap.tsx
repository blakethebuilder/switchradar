            ...
            >
              <Popup keepInView={true}>
                <div className="p-0 min-w-[280px]">
                  <div className="relative h-2 bg-gradient-to-r from-indigo-500 to-purple-500" />
                  <div className="p-5">
                    <div className="flex items-start justify-between gap-4 mb-4">
                      <div>
                        ...
                        <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">{business.category}</p>
                      </div>
                      <ProviderBadge provider={business.provider} className="font-bold shrink-0" />
                    </div>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="text-xs font-semibold text-slate-600 leading-relaxed">
                          {business.address}
                          <div className="mt-0.5 text-indigo-500 font-bold uppercase tracking-wider text-[9px]">
                            {business.town}
                          </div>
                        </div>
                      </div>
                      ...
                      {business.phone && (
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-xs font-bold text-slate-600">{business.phone}</span>
                        </div>
                      )}
                    </div>

                    <div className="mt-5 grid grid-cols-2 gap-2">
                      <button className="flex items-center justify-center gap-2 py-2.5 rounded-xl bg-indigo-600 text-white text-[10px] font-bold hover:bg-indigo-700 transition-colors">
                        <ExternalLink className="w-3.5 h-3.5" />
                        DETAILS
                      </button>
                      <button className="flex items-center justify-center gap-2 py-2.5 rounded-xl bg-slate-50 text-slate-600 text-[10px] font-bold hover:bg-slate-100 transition-colors">
